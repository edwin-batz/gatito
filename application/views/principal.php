...
<head>
	...
	<!-- <link rel="canonical" href="<?php echo base_url('assets/bootstrap/site/content/docs/5.3/examples/sign-in')?>"> -->
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/login.min.css')?>">
</head>
